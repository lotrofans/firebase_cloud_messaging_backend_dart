...
class LightSettings {
  ...
  factory LightSettings.fromJson(Map<String, dynamic> json) => _$LightSettingsFromJson(json);
...
class FCMColor {
  ...
  factory FCMColor.fromJson(Map<String, dynamic> json) => _$FCMColorFromJson(json);
